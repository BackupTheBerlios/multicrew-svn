...
// GCC pre-version 3 didn't handle typename in typedefs properly, so I needed to implement a work-around
//     after version 3, typename is required for a typedef in a template function under circumstances that aren't yet clear
