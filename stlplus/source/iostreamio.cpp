...
{
  return dynamic_cast<oiobuff*>(m_buffer.pointer())->m_stream;
}

const std::ostream& oiotext::get_stream(void) const
{
  return dynamic_cast<const oiobuff*>(m_buffer.pointer())->m_stream;
}
...
{
  return dynamic_cast<iiobuff*>(m_buffer.pointer())->m_stream;
}

const std::istream& iiotext::get_stream(void) const
{
  return dynamic_cast<const iiobuff*>(m_buffer.pointer())->m_stream;
}
