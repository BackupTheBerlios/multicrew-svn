...
public:
  ...
  unsigned size(const_iterator) const
    throw(wrong_object,null_dereference,end_dereference);
  unsigned size(iterator)
    throw(wrong_object,null_dereference,end_dereference);
  ...
  iterator root(void);
  unsigned children(const_iterator) const
    throw(wrong_object,null_dereference,end_dereference);
  unsigned children(iterator)
    throw(wrong_object,null_dereference,end_dereference);
  const_iterator child(const_iterator, unsigned child) const
    throw(wrong_object,null_dereference,end_dereference,std::out_of_range);
  iterator child(iterator, unsigned child)
    throw(wrong_object,null_dereference,end_dereference,std::out_of_range);
  const_iterator parent(const_iterator) const
    throw(wrong_object,null_dereference,end_dereference);
  ...
  iterator insert(iterator, unsigned, const T&)
    throw(wrong_object,null_dereference,end_dereference,std::out_of_range);
  iterator append(iterator, const T&) 
    throw(wrong_object,null_dereference,end_dereference);
  iterator insert(iterator, unsigned, const ntree<T>&)
    throw(wrong_object,null_dereference,end_dereference,std::out_of_range);
  iterator append(iterator, const ntree<T>&)
    throw(wrong_object,null_dereference,end_dereference);

  void erase(void);
  void erase(iterator)
    throw(wrong_object,null_dereference,end_dereference);
  void erase(iterator, unsigned)
    throw(wrong_object,null_dereference,end_dereference,std::out_of_range);

  ntree<T> subtree(void);
  ntree<T> subtree(iterator)
    throw(wrong_object,null_dereference,end_dereference);
  ntree<T> subtree(iterator, unsigned)
    throw(wrong_object,null_dereference,end_dereference,std::out_of_range);

  ntree<T> cut(void);
  ntree<T> cut(iterator)
    throw(wrong_object,null_dereference,end_dereference);
  ntree<T> cut(iterator, unsigned)
    throw(wrong_object,null_dereference,end_dereference,std::out_of_range);
  ...
  //////////////////////////////////////////////////////////////////////////////
private:
  void dump_r(dump_context&,const_iterator) const
    throw(persistent_dump_failed);
  void restore_r(restore_context&,iterator)
    throw(persistent_restore_failed);
  ntree_node<T>* m_root;
};
