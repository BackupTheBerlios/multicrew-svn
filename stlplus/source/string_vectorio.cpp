...
{
  return dynamic_cast<osvbuff*>(m_buffer.pointer())->m_data;
}

const std::vector<std::string>& osvtext::get_vector(void) const
{
  return dynamic_cast<const osvbuff*>(m_buffer.pointer())->m_data;
}
...
{
  return dynamic_cast<isvbuff*>(m_buffer.pointer())->m_data;
}

const std::vector<std::string>& isvtext::get_vector(void) const
{
  return dynamic_cast<const isvbuff*>(m_buffer.pointer())->m_data;
}
