...
public:
	 ...
	 *
	 * @param pubKeyP Public keys generated from the RSACrypt class. Can be 0
	 * @param pubKeyQ Public keys generated from the RSACrypt class. Can be 0 
	...
	*/
	 ...
	 * @param functionName a pointer to the C function. 
	 */
