...
public:
	 ...
	 * @param connectionValidationInteger is for legacy purposes and is unused
	 ...
	 *
	 * @param privateKeyE A pointer to the private keys from the RSACrypt class.  
	 * @param  privateKeyN A pointer to the private keys from the RSACrypt class.  
...
private:
	 ...
	 */
	unsigned long seed, nextSeed, nextSeedUpdate, broadcastPingsTime;
