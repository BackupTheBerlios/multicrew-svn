...
int main(void)
{
	...
	printf("Encryption Demo.  Select option:\n");
	PrintOptions();
	...
	while (1)
	{
		...
		else if (str[0]=='3')
		{
			...
			rakPeer2->Disconnect(0);
			rakPeer1->Disconnect(0);
			PrintOptions();
		}
